void function ($S) {
    ...
    Ime.enable = function (isClose) {
        ...
        if ((Ime.isEnable && Ime.isEnable()) && !isClose) return;
                ...
                if (!sa) {
                    ...
                    Q !== S && Function === S.toggle.constructor ? S.toggle() : (S = L[ja] = function () {
                        ...
                        P = function () {
                            ...
                            q = e = null,
                            x = {};
                            Ime.isEnable = function () {
                                var imeElement = document.getElementsByTagName(h[0]);
                                if (imeElement.length) {
                                    return imeElement.item(0).style.visibility != "hidden";
                                }
                                return false;
                            };
                            return {
    ...
    Ime.close = function () {
        ...
        if (!Ime.isEnable || !Ime.isEnable()) return;
        Ime.enable(true);
    };
